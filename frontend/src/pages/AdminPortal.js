...
export default function AdminPortal() {
  ...
  useEffect(() => {
    ...
    const fetchData = async () => {
      const response = await fetch("http://safar-production.up.railway.app/api/auth/getuser", {
        method: "GET",
        headers: {
    ...
    const fetchPin = async () => {
      const response = await fetch(`http://safar-production.up.railway.app/api/pin/displayAll`, {
        method: "GET",
        headers: {
          "Content-Type": "application/json",
          token: currUser,
